...
def guardar_google_sheets(conn_gs, datos, res):
    ...
    try:
        ...
        conn_gs.update(spreadsheet="https://docs.google.com/spreadsheets/d/e/2PACX-1vSkpTq2JhFI21b5IMSn8tl96dG2OGe_ec26rXRnXKL6CtMbrOeL08ynALgepcJEf4kGaSanUa"j_RBEN/pubhtml, worksheet=worksheet_usada, data=df_fin)
